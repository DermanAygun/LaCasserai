...
// Returns the private 'App\Repository\KamerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\KamerRepository.php';

return $this->privates['App\Repository\KamerRepository'] = new \App\Repository\KamerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
