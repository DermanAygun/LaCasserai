...
// Returns the private 'App\Repository\ExtrasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ExtrasRepository.php';

return $this->privates['App\Repository\ExtrasRepository'] = new \App\Repository\ExtrasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
