...
// Returns the private 'App\Repository\BetaalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\BetaalRepository.php';

return $this->privates['App\Repository\BetaalRepository'] = new \App\Repository\BetaalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
