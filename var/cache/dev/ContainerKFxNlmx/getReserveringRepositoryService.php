...
// Returns the private 'App\Repository\ReserveringRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ReserveringRepository.php';

return $this->privates['App\Repository\ReserveringRepository'] = new \App\Repository\ReserveringRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
