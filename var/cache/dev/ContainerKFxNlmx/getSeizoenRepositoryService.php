...
// Returns the private 'App\Repository\SeizoenRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SeizoenRepository.php';

return $this->privates['App\Repository\SeizoenRepository'] = new \App\Repository\SeizoenRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
