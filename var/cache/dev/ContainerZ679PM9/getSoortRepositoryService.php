...
// Returns the private 'App\Repository\SoortRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SoortRepository.php';

return $this->privates['App\Repository\SoortRepository'] = new \App\Repository\SoortRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
