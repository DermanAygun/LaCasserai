...
class __TwigTemplate_9e3f17ee4553c086c3afde7fd0552e1f168491d02f45bd942acdaf7a3e8f65b0 extends \Twig\Template
{
    private $source;
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 29
            echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["user"], "lastActivityAt", [])) ? (twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "lastActivityAt", []), "Y-m-d H:i:s")) : ("")), "html", null, true);
            echo "</td>
                <td>";
            // line 30
    ...
    <table class=\"table\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>{{ user.lastActivityAt ? user.lastActivityAt|date('Y-m-d H:i:s') : '' }}</td>
...
{% endblock %}
", "user/index.html.twig", "C:\\xampp\\htdocs\\Henry_Symfony\\hotel_lacasserai\\templates\\user\\index.html.twig");
    }
}
